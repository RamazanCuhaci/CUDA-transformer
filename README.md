...
Samples created for [PolyBench-ACC](https://github.com/cavazos-lab/PolyBench-ACC) benchmark programs. Samples link (https://drive.google.com/drive/folders/1aiotg3w3qJnpWaZLr2So1B73umVrQbQR?usp=sharing)
))
